 ...
 */
var producer = function (producerId, message, topic) { return __awaiter(void 0, void 0, void 0, function () {
    var kafka, producer, err_1, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_1 = _a.sent();
                console.log("Unable to connect to producer: ", err_1);
                return [3 /*break*/, 4];
            case 4:
                _a.trys.push([4, 6, , 7]);
            ...
            case 6:
                err_2 = _a.sent();
                console.log("Error sending to the producer: ", err_2);
                return [3 /*break*/, 7];
